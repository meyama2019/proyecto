...
<?php
  ...
  if(isset($_POST['updateuser'])) // ***************** Hay que cambiar para update de noticias 
  {
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                  <div class="form-row">
                      <div class="form-group col-md-1">
                        ...
                        <input readonly type="text" class="form-control" id="idnoticia" name ="idnoticia" aria-describedby="emailHelp" placeholder="Id" value=<?php echo($news_data['id_usuario']); ?>>
