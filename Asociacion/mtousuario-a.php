...
<?php
  ...
  if(isset($_POST['updateuser']))
  {
    ...
    {
      echo "<script>alert('MIERDA de Socio incorrecta');</script>";
    }
         ...
         <div class="container">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-3">
                        ...
                        <input required type="text" class="form-control" id="SocioUsuario" name ="SocioUsuario" aria-describedby="emailHelp" placeholder="Nombre de usuario" value= <?php echo($news_data['usuario']); ?>>
                        <small id="emailHelp" class="form-text text-muted">No compartas datos sensibles con otras personas.</small>
                      </div>
            ...
            <!--<div class="form-group">-->
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <input required type="text" class="form-control" id="NombreApellidosSocio" name ="NombreApellidosSocio" aria-describedby="emailHelp" placeholder="Nombre y Apellidos" value= <?php echo($news_data['Nom_Ape']); ?>>
                      </div>
                      <div class="form-group col-md-3">
                        <label for="SocioDNI">DNI</label>
                        <input required type="text" class="form-control" id="SocioDNI" name ="SocioDNI" aria-describedby="emailHelp" placeholder="DNI" value= <?php echo($news_data['dni']); ?>>
                        <small id="emailHelp" class="form-text text-muted">No compartas datos sensibles con otras personas.</small>
                      </div>
                  </div>
                  ...
                  <div class="form-row">
                        ...
                        <input required type="text" class="form-control" id="SocioTelf" name ="SocioTelf" aria-describedby="emailHelp" placeholder="Ej. +343987159" pattern="(\+34|0034|34)?[\s|\-|\.]?[6|7|9][\s|\-|\.]?([0-9][\s|\-|\.]?){8}" value= <?php echo($news_data['telefono']); ?>>
                        <small id="emailHelp" class="form-text text-muted">No compartas datos sensibles con otras personas.</small>
                      </div>
