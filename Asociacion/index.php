...
<br>
      ...
      <div class="container">
		    <div class="row">
		      <div class="col-12 col-5 shadow p-3 mb-5 bg-white rounded" id="borderDemo">
             <article id="general">
			 <div id="demotext">
				<h3 class=".jackInTheBox" align="center"><u class=".jackInTheBox">NUESTRA ASOCIACIÓN</u></h3>
			</div>	
                <p  class=".jackInTheBox">Fundada en el 2019 y registrada e inscrita en el registro de Asociaciones Profesionales del Departamento de Justicia, Empleo y Seguridad Social con nº 2019/7. <br>
