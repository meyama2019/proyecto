         ...
         height: 250px;
            ...
            <div class="alert alert-success" role="alert">
                <div class="col-12 col-5 shadow p-3 mb-5 bg-white rounded">
                 <article id="general">
                    <center><h3 class="titgeneral">¡ Se ha actualizado Roles de Usuario</h3></center>
                    <center><a class="btn btn-primary" href="http://localhost/proyecto/asociacion/mtoroles.php" role="button">Cerrar</a></center>
